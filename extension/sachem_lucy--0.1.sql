...
CREATE FUNCTION "lucy_substructure_search"(varchar, int, int = 0, int = 0, int = 2, int = 0, int = 0, int = 0, int = 5000) RETURNS SETOF int AS 'MODULE_PATHNAME','lucy_substructure_search' LANGUAGE C IMMUTABLE STRICT SECURITY DEFINER;
CREATE FUNCTION "orchem_sync_data"(boolean = false) RETURNS void AS 'MODULE_PATHNAME','lucy_sync_data' LANGUAGE C IMMUTABLE STRICT SECURITY DEFINER;
