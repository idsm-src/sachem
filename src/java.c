        ...
        JavaVMInitArgs args = (JavaVMInitArgs) {
            ...
            .options = (JavaVMOption []) { (JavaVMOption) {
                .optionString = "-Djava.class.path=" JARDIR "/sachem.jar:"
                                                     JARDIR "/beam-core-1.3.5.jar:"
                                                     JARDIR "/cdk-atomtype-2.9.jar:"
                                                     JARDIR "/cdk-core-2.9.jar:"
                                                     JARDIR "/cdk-ctab-2.9.jar:"
                                                     JARDIR "/cdk-interfaces-2.9.jar:"
                                                     JARDIR "/cdk-ioformats-2.9.jar:"
                                                     JARDIR "/cdk-isomorphism-2.9.jar:"
                                                     JARDIR "/cdk-silent-2.9.jar:"
                                                     JARDIR "/cdk-smiles-2.9.jar:"
                                                     JARDIR "/cdk-standard-2.9.jar:"
                                                     JARDIR "/cdk-valencycheck-2.9.jar:"
                                                     JARDIR "/guava-32.1.2-jre.jar:"
