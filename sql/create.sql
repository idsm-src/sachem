...
CREATE FUNCTION "lucy_substructure_search"(varchar, varchar, int, boolean, boolean, boolean) RETURNS SETOF int AS 'libpgchem.so','lucy_substructure_search' LANGUAGE C IMMUTABLE STRICT;
